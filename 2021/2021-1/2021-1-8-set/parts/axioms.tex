...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.45\textwidth}
      \fig{width = 0.50\textwidth}{figs/Zermelo}{\centerline{Ernst \blue{Z}ermelo (1871--1953)}}
    \column{0.45\textwidth}
      \fig{width = 0.48\textwidth}{figs/Fraenkel}{\centerline{Abraham \blue{F}raenkel (1891--1965)}}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%
\input{parts/axioms-EE}
\input{parts/axioms-PURP}
% \input{parts/axioms-IC}
% \input{parts/axioms-F}
%%%%%%%%%%%%%%%
