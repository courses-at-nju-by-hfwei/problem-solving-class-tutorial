...
%       \fig{width = 0.40\textwidth}{figs/cantor-1870}{\vspace{-0.20cm}\centerline{Georg Cantor}}
%     \pause
%     \column{0.50\textwidth}
%       \begin{columns}
% 	\column{0.50\textwidth}
% 	  \fig{width = 0.50\textwidth}{figs/Frege-old}{\vspace{-0.50cm}\centerline{Gottlob Frege}}
% 	\column{0.50\textwidth}
% 	  \fig{width = 0.50\textwidth}{figs/Russell}{\vspace{-0.50cm}\centerline{Bertrand Russell}}
%       \end{columns}
%       \begin{columns}
% 	\column{0.50\textwidth}
% 	  \fig{width = 0.50\textwidth}{figs/Zermelo-old}{\vspace{-0.50cm}\centerline{Ernst Zermelo}}
% 	\column{0.50\textwidth}
% 	  \fig{width = 0.50\textwidth}{figs/von-Neumann}{\vspace{-0.50cm}\centerline{John von Neumann}}
%       \end{columns}
%   \end{columns}
% \end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{columns}
    ...
    \column{0.45\textwidth}
      \pause
      \fig{width = 0.45\textwidth}{figs/frege-arithmetic}{\centerline{``Basic Laws of Arithmetic''}}
  \end{columns}
...
\begin{frame}{}
  ...
  \fig{width = 0.15\textwidth}{figs/cantor}
