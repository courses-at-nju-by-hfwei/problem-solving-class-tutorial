...
\begin{frame}{}
  ...
  \begin{theorem}[Distributive Property (Theorem $7.1$)]
    ...
    \fig{width = 0.40\textwidth}{figs/distributive-proof}
  \end{theorem}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.50cm}
  \fig{width = 0.35\textwidth}{figs/known-unknown}

  \pause
  \centerline{\blue{For any given $x, \cdots$}}
...
\begin{frame}{}
  \begin{exampleblock}{Equivalence: UD $7.8$}
	...
	\uncover<6->{
	  \fig{width = 0.60\textwidth}{figs/ambiguous}
	}
    \end{columns}
...
\begin{frame}{}
  \begin{exampleblock}{Equivalence: UD $7.8$}
	...
	\end{enumerate}
      \column{0.50\textwidth}
	\uncover<2->{
	  \fig{width = 0.70\textwidth}{figs/A-B-Cc}
	}
    \end{columns}
