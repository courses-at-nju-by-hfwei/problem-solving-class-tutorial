...
\begin{frame}{}
  \begin{center}
    ...
    \pause
    ``$W(n)$ is a function whose \red{order of magnitude} is \teal{uppper-bounded} \\
...
\begin{frame}{}
  \begin{center}
    ...
    \pause
    ``$f(n)$ is a function whose \red{order of magnitude} is \teal{uppper-bounded} \\
