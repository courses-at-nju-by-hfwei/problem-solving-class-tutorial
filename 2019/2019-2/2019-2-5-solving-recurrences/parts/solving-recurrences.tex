...
\begin{frame}{}
  ...
  \pause
  \vspace{0.50cm}
  \begin{theorem}[First-order Linear Recurrences with \red{\it Constant Coefficients} (CS Theorem $4.5$)]
    \[
      T(n) = \left\{\begin{array}{lr}
	a		& n = 0 \\
	\red{r}T(n-1) + g(n) & n > 0 
...
\begin{frame}{}
  ...
  \pause
  \fig{width = 0.55\textwidth}{figs/doit-duck}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \pause
  \fig{width = 0.50\textwidth}{figs/fib-noip}
  \[
...
\begin{frame}{}
  ...
  {\teal{\small {\it How to Find a \red{Particular Solution} for a Non-homogeneous Recurrence Relation?}}}}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.50cm}
  \centerline{\teal{Generating Functions and Asymptotic Analysis}}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.80cm}
  \centerline{\teal{Generating Functions}}
\end{frame}
%%%%%%%%%%%%%%%
